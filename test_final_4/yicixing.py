...
score_range = range(2, 13)  # 分数范围是2到12
max_per_score = 30

# 分析文本
score_data, essay_data = analyze_texts_by_score(file_path, score_range, max_per_score)

# 计算平均值
average_data = calculate_averages(score_data)

# 保存到JSON文件
save_to_json(average_data, 'average_scores.json')
save_to_json(essay_data, 'essay_details.json')
